...
CLt::CLt(std::shared_ptr<CExpr> first, std::shared_ptr<CExpr> second)
...
CValue CLt::getValue(const std::unordered_map<CPos, CBuilder, CPosHash>& map,
...
std::shared_ptr<CExpr> CLt::clone() const
{
